...
import "../ProfilePagePasswordEO/ProfilePagePasswordEO.css"

const ProfilePagePasswordEO = () => {
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="save-button flex flex-col lg:flex-row gap-4 items-center justify-center py-6 w-full">
                    ...
                    <button
                      ...
                      className={`${
                        isFormValid
                          ? "bg-customBlue border-2 border-white font-medium w-full sm:w-1/3 h-11 my-2 rounded-lg text-medium text-white text-[16px] hover:shadow-lg transition duration-30"
...
export default ProfilePagePasswordEO;
