...
const KodeUnik = () => {
  ...
  // useEffect(() => {
  //   fetch('https://api.example.com/get-ticket-code') // Ganti dengan endpoint API yang sesuai
  ...
  return (
    <div className="unique-code h-screen sm:h-[1024px] mx-4 sm:mx-12 lg:mx-20 flex items-center justify-center" >
      <div className={`container w-full sm:w-3/4 lg:w-1/2 h-auto sm:h-11/12 py-6 mx-8 bg-white shadow-lg rounded-2xl flex flex-col items-center ${fadeClass}`}>
